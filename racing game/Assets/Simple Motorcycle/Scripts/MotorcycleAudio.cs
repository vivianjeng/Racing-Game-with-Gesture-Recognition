...
namespace Motorcycle
{
    ...
    public class MotorcycleAudio : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_MotorcycleController.Revs);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(m_MotorcycleController.AccelInput);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_MotorcycleController.Revs);
